...
import { Award, Quote, Heart, Medal, Target, Landmark, Globe, ArrowUpRight } from "lucide-react";
...
const ChairmansMessage = () => {
  ...
  const chairmanData = {
    ...
    suffix: "B.A.",
    bio: "A visionary leader who believes that education is a noble process of conditioning the human mind in its formative years. Under his stewardship since 2008, ALITS has become a hub for innovation and teamwork, producing talented professionals driven by ethical values and a spirit of societal responsibility.",
    quote: "Education not only sculpts a good human being but also inculcates a sense of responsibility with principles and values towards society.",
    stats: [
      { label: "Visionary Founder", icon: Target },
      { label: "Value-Based Ethics", icon: Medal },
      { label: "Innovation Leader", icon: Landmark },
      { label: "Social Advocate", icon: Heart }
    ],
    awards: [
      {
        title: "Learning Innovation",
        year: "2012",
        presenter: "Gov. Sri. E.S.L. Narasimhan",
        image: award01,
        desc: "Awarded for pioneering innovative educational practices in the region."
      },
      {
        title: "Global Integration",
        year: "INTL",
        presenter: "Thailand Deputy P.M.",
        image: award02,
        desc: "Recognized for contributions to economic development and integration."
      },
      {
        title: "Gold Medal for Excellence",
        year: "NATL",
        presenter: "Chattishgadh Governer",
        image: award03,
        desc: "Honored for distinguished leadership and excellence in social service."
      }
    ]
  };

  return (
    <AboutLayout title="Chairman's Message">
            ...
            >
              ...
              <div className="absolute -bottom-10 -right-4 bg-white/90 backdrop-blur-xl p-6 rounded-3xl shadow-2xl flex items-center gap-4 border border-white/50">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-slate-900">18+ Years Leadership</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-28 px-8 md:px-20 bg-slate-900 rounded-[4rem] overflow-hidden shadow-2xl">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-10 relative z-10">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <span className="text-[#D4AF37] text-[10px] font-black uppercase tracking-[0.4em]">The Core Philosophy</span>
            </div>
          </div>
        </section>
        ...
        <section ref={revealRef} className="space-y-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200/60 pb-12">
            ...
            <div className="flex items-center gap-3 text-slate-900 font-black group cursor-pointer text-[10px] uppercase tracking-widest">
              <span className="border-b-2 border-[#D4AF37] pb-1">Award Gallery</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {chairmanData.awards.map((award, i) => (
              <div
                key={i}
