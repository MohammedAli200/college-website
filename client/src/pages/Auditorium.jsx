...
const Auditorium = () => {
  ...
  return (
    ...
    <div className="relative h-[60vh] min-h-[500px] rounded-[3rem] overflow-hidden shadow-2xl group">
       <div className="absolute inset-0 bg-gradient-to-t from-[#312E81] opacity-80 mix-blend-multiply z-10 transition-opacity duration-1000 group-hover:opacity-60"></div>
       ...
       <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-8 text-center">
          <h1 className="text-5xl md:text-8xl font-serif font-black text-white mb-6 drop-shadow-2xl translate-y-4 group-hover:translate-y-0 transition-transform duration-700">Auditorium</h1>
          <p className="text-[#818CF8] text-xl font-bold uppercase tracking-[0.3em] drop-shadow-md">Campus Facilities</p>
       </div>
    </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
       {[1,2,3,4].map(i => (
          <div key={i} className="bg-white p-8 rounded-[2rem] border border-[#EADBC8] hover:shadow-xl hover:-translate-y-2 transition-all flex flex-col justify-center text-center group cursor-pointer">
             <div className="w-16 h-16 mx-auto rounded-full bg-[#FFF7E6] flex items-center justify-center text-[#818CF8] font-black text-2xl mb-6 group-hover:scale-110 transition-transform">{i}</div>
