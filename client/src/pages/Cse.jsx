  ...
  return (
    <BokehBackground className="min-h-screen" count={15} speed={0.5}>
      ...
      <main className="relative z-10 w-full ${false ? 'pt-32' : 'pt-48 md:pt-56 lg:pt-64'} pb-32 px-4 sm:px-6 md:px-12 max-w-[100rem] mx-auto flex flex-col items-center">
        ...
        <div className="w-full bg-gradient-to-b from-[#020617] to-[#1E293B] p-12 md:p-24 rounded-[3rem] text-white shadow-2xl relative overflow-hidden my-12 border border-white/10">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
               ...
               <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 leading-tight">Innovating the <br/><span className="text-[#38BDF8]">Digital Frontier.</span></h2>
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm">
                     <span className="text-[#38BDF8] text-4xl font-black block mb-1">500+</span>
                     <span className="text-white/50 text-xs uppercase tracking-widest font-bold">Placed Alumni</span>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-sm">
                     <span className="text-[#38BDF8] text-4xl font-black block mb-1">12</span>
        ...
        <div className="mt-24 border-t border-white/10 pt-16 grid md:grid-cols-3 gap-8 relative z-10">
           {["Cybersecurity Cell", "AI Research Lab", "Cloud Computing Center"].map((lab, i) => (
              <div key={i} className="flex gap-4 items-start group cursor-pointer">
                 <div className="text-[#38BDF8] bg-white/5 p-3 rounded-lg group-hover:bg-white/20 transition-colors">
                 ...
                 <div>
                    <h4 className="font-bold text-white mb-1 group-hover:text-[#38BDF8] transition-colors">{lab}</h4>
