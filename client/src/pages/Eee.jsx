    ...
    <div className="grid lg:grid-cols-12 gap-12">
       <div className="lg:col-span-8 space-y-12">
          <div className="bg-white p-12 rounded-[3rem] border border-[#EADBC8] shadow-lg relative overflow-hidden">
             <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#4C1D95] to-[#312E81] opacity-5 rounded-bl-full pointer-events-none"></div>
             ...
             <p className="text-[#6B4F3B] text-lg leading-relaxed font-light mb-8">
               A center of excellence dedicated to cultivating deep expertise in Electrical & Electronics. Our faculty brings decades of combined industry and academic experience to the classroom.
             </p>
       ...
       <div className="lg:col-span-4 space-y-8">
          <div className="bg-gradient-to-br from-[#4C1D95] to-[#312E81] p-10 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden">
             ...
             <div className="flex gap-4 items-center mb-6 relative z-10">
                ...
                <div>
                   ...
                   <div className="text-[#A78BFA] text-xs uppercase tracking-widest font-bold">HOD</div>
                </div>
             </div>
